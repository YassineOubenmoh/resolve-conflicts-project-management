...
const Badge: React.FC<BadgeProps> = ({
  ...
  const sizeStyles = {
    sm: "text-theme-xs", // Smaller font size
  ...
  const variants = {
    light: {
      ...
      danger: "bg-red-100 text-red-700 dark:bg-red-500/15 dark:text-red-500",
      purple: "bg-purple-100 text-purple-700 dark:bg-purple-500/15 dark:text-purple-400",
      secondary: "bg-gray-300 text-gray-800 dark:bg-white/10 dark:text-white/80",
    ...
    solid: {
      ...
      secondary: "bg-gray-500 text-white dark:text-white",
    },
  };

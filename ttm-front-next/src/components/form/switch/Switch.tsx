...
interface SwitchProps {
  ...
  color?: "blue" | "gray"; // Existing color options
...
const Switch: React.FC<SwitchProps> = ({
  ...
  onChange,
  color = "blue",
  customColor, // Accept custom color
}) => {
  ...
  const switchColors =
    customColor // Use custom color if provided
      ? {
        background: isChecked ? customColor : "bg-gray-200 dark:bg-white/10",
    ...
    >
      <div className="relative">
        <div
          ...
          style={customColor ? { backgroundColor: isChecked ? customColor : "#e5e7eb" } : {}}
        ></div>
        <div
